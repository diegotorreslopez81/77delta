...
def main():
    ...
    elif a.cmd in ('frentes', 'bloques', 'feed', 'kit', 'contacto', 'interaccion', 'cliente', 'persona', 'colaborador', 'expediente', 'sesion', 'agente') or (a.cmd == 'encargo' and (a.sub in ('tomar', 'hecho', 'editar', 'estado', 'ficha') or (a.sub == 'alta' and a.id is None and getattr(a, 'frente', None)))):
        if hq_v2 is None:
