...
def main():
    ...
    elif a.cmd in ('frentes', 'bloques', 'feed', 'kit', 'contacto') or (a.cmd == 'encargo' and (a.sub in ('tomar', 'hecho', 'editar', 'estado') or (a.sub == 'alta' and a.id is None and getattr(a, 'frente', None)))):
